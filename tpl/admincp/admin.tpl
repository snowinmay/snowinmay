...
<!--{if $a eq "run"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：系统设置<span>&gt;&gt;</span>管理员设置<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=admin">帐号列表</a></p></div>
  <div class="main-cont">
    <h3 class="title"><a href="<!--{$cpfile}-->?c=admin&a=add" class="btn-general"><span>添加帐号</span></a>帐号列表</h3>
...
<!--{if $a eq "add"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：系统设置<span>&gt;&gt;</span>管理员帐号<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=admin&a=add">添加管理员</a></p></div>
  <div class="main-cont">
...
<div class="main-wrap">
  ...
  <div class="main-cont">
	...
	<table cellpadding='3' cellspacing='3' class='tab'>
	  ...
	  <tr>
		<td class='hback_1'>备注说明 </td>
		<td class='hback'><textarea name="memo" id="memo" style="width:50%;height:85px;overflow:auto;color:#444444;"><!--{$admin.memo}--></textarea></td>
	  </tr>
	  <tr>
