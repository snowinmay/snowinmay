  ...
  <div class="main-cont">
	...
	<div class="search-area ">
	  ...
	  <div class="item">
		...
		<label>广告名称：</label><input type="text" id="sname" name="sname" class="input-150" value="<!--{$sname}-->" />&nbsp;&nbsp;&nbsp;
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" align="center">
	  ...
	  <tr onMouseOver="overColor(this)" onMouseOut="outColor(this)">
		...
		<td align="center"><!--{hook mod='category' type='text' value=$volist.catid}--></td>
		<td align="left"><!--{$volist.adname}--> (<a href="<!--{$volist.normbody.uploadfiles}-->" target="_blank">查看</a>)</td>
		<td align="left"><!--{$volist.tagname}--></td>
		<td align="left"><!--{$volist.normbody.type}--> <!--{$volist.normbody.width}-->X<!--{$volist.normbody.height}-->像素</td>
  ...
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='2' class='tab'>
	  ...
	  <tr>
		...
		<select name="catid" id="catid">
		  <option value="0">可选择</option>
		  <!--{hook mod='category' type='option' value=$myads.catid}-->
		</select>
		<span id='dcatid' class='f_red'></span>
		<br />
		<font color="gray">(当根节点指定了广告，子栏目不选时，继承根节点。)</font>
	  ...
	  <tr>
		...
		<td class='hback'>
		  ...
		  <a href="<!--{$myads.normbody.uploadfiles}-->" target="_blank">查看</a>
		  <font color='#999999'>上传图片只支持：gif,jpeg,jpg,png格式</font>
	    </td>
	  </tr>
	  <tr>
