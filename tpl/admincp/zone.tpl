  ...
  <div class="main-cont">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" align="center">
	  ...
	  <tr onMouseOver="overColor(this)" onMouseOut="outColor(this)">
		...
		<td align="center"><!--{$volist.zonewidth}-->x<!--{$volist.zoneheight}-->(像素)</td>
	  ...
	  <tr>
		...
		<td class="hback" colspan="7"><input class="button" name="btn_del" type="button" value="删 除" onClick="{if(confirm('确定要删除选定信息？')){$('#myform').submit();return true;}return false;}" class="button">&nbsp;&nbsp;共[ <b><!--{$total}--></b> ]条记录</td>
	  </tr>
	  <!--{/if}-->
	</table>
	</form>
