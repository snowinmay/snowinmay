...
<!--{if $a eq "run"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：插件应用<span>&gt;&gt;</span>扩展应用<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=guestbook">留言管理</a></p></div>
  <div class="main-cont">
    <h3 class="title"><a href="<!--{$cpfile}-->?c=guestbook&a=add" class="btn-general"><span>添加留言</span></a>留言管理</h3>
...
<!--{if $a eq "add"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：插件应用<span>&gt;&gt;</span>扩展应用<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=guestbook&a=add">添加留言</a></p></div>
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='1' class='tab'>
	  <tr>
		...
		<td class='hback' width='85%'><input type="text" name="username" id="username" class="input-80"  /> <span id='dusername' class='f_red'></span> 姓名长度不能大于50个任意字符</td>
	  </tr>
	  <tr>
...
<!--{if $a eq "edit"}-->
<div class="main-wrap">
  <div class="path"><p>当前位置：插件应用<span>&gt;&gt;</span>扩展应用<span>&gt;&gt;</span>编辑/回复留言</p></div>
  <div class="main-cont">
	...
	<table cellpadding='1' cellspacing='2' class='tab'>
	  <tr>
		<td class='hback_1' width='15%'>姓名 <span class="f_red">*</span> </td>
		<td class='hback' width='85%'><input type="text" name="username" id="username" class="input-80" value="<!--{$guestbook.username}-->" /> <span id='dusername' class='f_red'></span> 姓名长度不能大于50个任意字符</td>
	  </tr>
	  <tr>
		<td class='hback_1'>标题 <span class="f_red">*</span> </td>
