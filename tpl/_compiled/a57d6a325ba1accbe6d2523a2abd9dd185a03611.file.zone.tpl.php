<?php /* Smarty version Smarty-3.1.14, created on 2015-04-28 17:17:41
         compiled from "/var/www/html/snowinmay/tpl/admincp/zone.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2139036565553f503559e8b9-43551084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a57d6a325ba1accbe6d2523a2abd9dd185a03611' => 
    array (
      0 => '/var/www/html/snowinmay/tpl/admincp/zone.tpl',
      1 => 1396230332,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2139036565553f503559e8b9-43551084',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_553f503564af67_31199999',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_553f503564af67_31199999')) {function content_553f503564af67_31199999($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_stripslashes')) include '/var/www/html/snowinmay/source/core/smarty/plugins/modifier.stripslashes.php';
...
?>
	  ...
	  <tr>
		...
		<td class="hback" colspan="7"><input class="button" name="btn_del" type="button" value="删 除" onClick="{if(confirm('确定要删除选定信息？')){$('#myform').submit();return true;}return false;}" class="button">&nbsp;&nbsp;共[ <b><?php echo $_smarty_tpl->tpl_vars['total']->value;?>
</b> ]条记录</td>
	  </tr>
	  <?php }?>
	</table>
